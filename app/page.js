  ...
  return (
    <>
      ...
      <Section id="certificates">
        <section className="home-sec">
          <div className="container">
            <SectionTitle id="certificates" fallback="گواهی‌شده توسط دیتاکالا" />
            <div className="cert-grid">
              {[
                ...
                ["/images/20251204162812okueog.svg", "پشتیبانی لحظه‌ای", "دیتاکالا کل فرآیند از پیش‌فروش تا حین فروش و پس از فروش را پشتیبانی می‌کند."],
                ["/images/20251204162812ko3zlo.svg", "تحقیق و توسعه قابل سفارشی‌سازی", "مرکز تحقیق و توسعه پیشرفته دیتاکالا نرم‌افزار و سخت‌افزار را مطابق نیاز شما سفارشی می‌کند."],
                ["/images/20251204162812zeli7n.svg", "تست جامع", "۸ آزمایشگاه برتر، محصولات و راه‌حل‌های شما را به‌صورت جامع می‌آزمایند."],
                ["/images/20251204162812mn2i7p.svg", "کیفیت گواهی‌شده", "محصولات دیتاکالا گواهی‌های بین‌المللی متعددی مانند ISO، CE، RoHS و غیره را کسب کرده‌اند."],
              ].map(([img, t, d]) => (
        ...
        <section className="home-sec">
          <div className="container">
            ...
            <div className="case-grid">
              {[
                ["/images/20240629103850kymtvo.png", "ایالات متحده", "دیتاکالا به یک استارتاپ خودرو خودران در ساخت شبکه دیتاسنتر کمک کرد", "دیتاسنتر سازمانی  |  رانندگی خودران"],
                ["/images/20240629103850pixlsb.jpg", "آلمان", "Dream Chip پایداری شبکه را با راه‌حل MLAG شرکت دیتاکالا بهبود داد", "دیتاسنتر سازمانی  |  تولید"],
                ["/images/20240629103850zdlu9m.png", "ژاپن", "ارتقای یکپارچه شبکه صنعت سرگرمی با راه‌حل VXLAN شرکت دیتاکالا", "اتصال بین‌دیتاسنتری  |  ورزش، رسانه و سرگرمی"],
              ].map(([img, loc, t, tags]) => (
