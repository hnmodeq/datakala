      ...
      <section className="section">
        <div className="container split">
          <div>
            ...
            <p style={{ color: "#555" }}>معماری کابل‌کشی فیبر چگالی بالا با تنه MTP®، بریک‌اوت و اپتیک 800G/1.6T برای ارتباط GPU کم‌تأخیر. طراحی، تست و تحویل به‌صورت یک بسته خدمات.</p>
            <ul className="hl">
