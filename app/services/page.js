    ...
    <>
      ...
      <section className="section">
        <div className="container split">
          <div>
            <h2>چرا خدمات راه‌حل دیتاکالا</h2>
            <p style={{ color: "var(--muted)" }}>دیتاکالا به رضایت مشتری با تمرکز بر کیفیت و مدیریت هزینه متعهد است. شبکه جهانی، کارکنان ماهر و موجودی محلی دسترسی را هرجا که نیاز دارید فراهم می‌کند. به ما برای راه‌حل‌های کارآمد و قابل استقرار اعتماد کنید.</p>
            <ul className="hl">
