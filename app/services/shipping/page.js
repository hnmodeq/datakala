      ...
      <section className="section">
        <div className="container policy-layout">
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)" }}>دیتاکالا ارسال همان‌روز کالاهای موجود را از انبارهای دلاور و کالیفرنیا ارائه می‌دهد. سفارش‌های بالای ۷۹ تومان ارسال رایگان دارند (به‌جز اضافه وزن، اقلام سفارشی و مقاصد خاص).</p>
            ...
            <p style={{ color: "var(--muted)" }}>سفارش‌ها از انبارهای دلاور و کالیفرنیا به هر ۵۰ ایالت، پورتوریکو و آدرس‌های APO/FPO ارسال می‌شوند. کالاهای موجود معمولاً همان روز کاری ارسال می‌شوند اگر قبل از ساعت ۱۶:۰۰ به وقت محلی ثبت شوند.</p>
            <div className="faq">
              <h3>هزینه ارسال چقدر است؟</h3>
              <p>هزینه بر اساس گزینه تحویل در تسویه محاسبه می‌شود. در آمریکا برای سفارش بالای ۷۹ تومان ارسال رایگان است.</p>
