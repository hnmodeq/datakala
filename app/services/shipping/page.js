      ...
      <section className="section">
        <div className="container policy-layout">
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)" }}>FS ارسال همان‌روز کالاهای موجود را از انبارهای دلاور و کالیفرنیا ارائه می‌دهد. سفارش‌های بالای ۷۹ دلار آمریکا ارسال رایگان دارند (به‌جز اضافه وزن، اقلام سفارشی و مقاصد خاص).</p>
