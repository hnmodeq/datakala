      ...
      <section className="section">
        <div className="container split">
          <div>
            ...
            <p style={{ color: "var(--muted)" }}>FS از تولید هوشمند پیشرفته و قابلیت تحویل جهانی در صنعت ICT بهره می‌برد. با سیستم‌های SAP ERP، برنامه‌ریزی پیشرفته (APS)، سیستم اجرای تولید (MES) و رویه‌های عملیاتی استاندارد، محیط کلین‌روم کلاس ۱۰۰٬۰۰۰ را برای تولید باکیفیت تضمین می‌کنیم.</p>
          </div>
